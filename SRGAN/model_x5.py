...
class SRResNet(nn.Module):
    def __init__(
        ...
        elif upscale_factor == 5:
            upsampling.append(_UpsampleBlock(channels, 5))
...
class _UpsampleBlock(nn.Module):
    def __init__(self, channels: int, upscale_factor: int) -> None:
        ...
        self.conv = nn.Conv2d(channels, channels * upscale_factor * upscale_factor, (3, 3), (1, 1), (1, 1))
