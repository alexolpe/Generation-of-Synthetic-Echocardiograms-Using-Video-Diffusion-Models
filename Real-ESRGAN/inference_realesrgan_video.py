...
def run(args):
    ...
    video_save_path = osp.join(args.output, f'{args.video_name}_{args.suffix}.avi')
...
def main():
    ...
    #A: els 3 args de sota son els que realment m'interesen
    parser.add_argument('-i', '--input', type=str, default=os.path.abspath(os.path.join(script_path, '..', '..', '..', 'data', 'aolivepe', 'newpreprocessedData', 'psnr_Real-ESRGAN_2', '2-video012_40x384x512(1).avi')), help='Input video, image or folder')
    parser.add_argument('-o', '--output', type=str, default=os.path.abspath(os.path.join(script_path, '..', '..', '..', 'data', 'aolivepe', 'newpreprocessedData', 'psnr_Real-ESRGAN_2')), help='Output folder')
    parser.add_argument('-m', '--model_path', type=str, default='./experiments/train_RealESRGANx4_96x128_384x512/models/net_g_290000.pth', help='Trained model path')
    
    parser.add_argument('-n', '--model_name',type=str,default='realesr-animevideov3',help=('Model names: realesr-animevideov3 | RealESRGAN_x4plus_anime_6B | RealESRGAN_x4plus | RealESRNet_x4plus |'' RealESRGAN_x2plus | realesr-general-x4v3''Default:realesr-animevideov3'))
